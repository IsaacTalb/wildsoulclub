-- Customer-facing KPay references contain the order total in whole thousands
-- (with grouping separators where needed) and a numeric six-digit random code.
-- Examples: 138,500 MMK -> 138K-891839 and 1,250,500 MMK -> 1,250K-891839.

...
export type ResourceField = { key: string; label: string; type?: "text" | "number" | "date" | "datetime-local" | "textarea" | "boolean" | "select"; required?: boolean; options?: string[] };

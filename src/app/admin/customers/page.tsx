...
type CustomerRow = {
  id: string; full_name: string | null; email: string | null; phone?: string | null; is_guest: boolean;
...
export default function AdminCustomersPage() {
  ...
  return (
    <div className="space-y-5">
      <div><h1 className="text-2xl font-bold md:text-3xl">Customers</h1><p className="text-sm text-muted-foreground">Registered customers and guest purchasers, including saved delivery addresses.</p></div>

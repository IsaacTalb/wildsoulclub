...
const resources = {
  ...
  drops: { table: "drops", orderBy: "release_date", fields: ["collection_id", "name", "slug", "description", "season", "release_date", "status", "banner_image_url", "banner_object_key", "banner_position_x", "banner_position_y"] },

...
const DROP_SELECT = `id, collection_id, name, slug, description, season, release_date, status, banner_image_url, banner_object_key, banner_position_x, banner_position_y, created_at, updated_at, collections(id, name, slug), products(${PRODUCT_SELECT})`;
